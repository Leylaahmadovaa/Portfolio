        ...
        <div className="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 translate-x-[-30px] mt-[30px]">
          <div className="flex flex-col items-center justify-center gap-[20px]">
            <div className="flex flex-col items-center border-2 rounded-full w-[150px] h-[200px] justify-center gap-[20px] hover:border-[#5c797a] transition-all duration-500">
              <img
                className="xl:w-[85px] md:w-[50px] w-[70px]"
                src="https://i.postimg.cc/RFwHxhBg/html.avif"
                alt="logo"
              />
          ...
          <div className="flex flex-col items-center justify-center gap-[20px]">
            <div className="flex flex-col items-center border-2 rounded-full w-[150px] h-[200px] justify-center gap-[20px] hover:border-[#5c797a] transition-all duration-500">
              <img
                className="xl:w-[85px] md:w-[50px] w-[70px]"
                src="https://i.postimg.cc/bYHmQNt0/css.png"
                alt="logo"
              />
              <p className="text-[#5c797a] text-[28px] font-semibold">90%</p>
            </div>
            <p className="text-white font-semibold xl:mb-0 md:mb-0 mb-[30px]">
              CSS
            </p>
          </div>
          <div className="flex flex-col items-center justify-center gap-[20px]">
            <div className="flex flex-col items-center border-2 rounded-full w-[150px] h-[200px] justify-center gap-[20px] hover:border-[#5c797a] transition-all duration-500">
              <img
                className="xl:w-[85px] md:w-[50px] w-[70px]"
                src="https://i.postimg.cc/sfcJM6kw/javascript.png"
                alt="logo"
              />
          ...
          <div className="flex flex-col items-center justify-center gap-[20px]">
            <div className="flex flex-col items-center border-2 rounded-full w-[150px] h-[200px] justify-center gap-[20px] hover:border-[#5c797a] transition-all duration-500">
              <img
                className="xl:w-[85px] md:w-[50px]"
                src="https://i.postimg.cc/c4zw3VXM/react.png"
                alt="logo"
              />
