  ...
  return (
    <div
      className={`xl:px-[120px] md:px-[120px] px-[50px] py-[140px] fixed bg-[#5c797a] h-[100vh] right-0 z-[2] translate-y-[-30px] transition-all duration-1000 transition-(opacity, visiblity) ${
        config ? "opacity-100 visible w-[65%]" : "opacity-0 invisible w-[0px]"
      }`}
    >
      <div
        className="absolute right-[20px] top-[20px] text-white border-2 border-white w-[40px] h-[40px] rounded-full flex items-center justify-center hover:cursor-pointer"
        onClick={() => dispatch(check())}
      >
        X
      </div>
      <h1 className="text-white xl:text-[40px] md:text-[40px] text-[20px] mb-[20px]">
        Configuration
      </h1>
