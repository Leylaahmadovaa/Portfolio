...
const Main: React.FC=()=>{
  ...
  const dispatch = useDispatch()
    return <div className="xl:w-[60%] md:w-[60%] w-full xl:pt-0 md:pt-0 pt-[50px] xl:pl-0 md:pl-0 pl-[50px]">
        ...
        <h1 className="xl:text-[70px] md:text-[35px] text-[35px] w-[80%] text-white">
            <span style={{color:color}}>Leyla Ahmadova</span>, Front-End developer
        </h1>
        <p className="text-[#445e5f] font-semibold xl:text-[17px] md:text-[14px] mt-[30px] md:w-[300px]">I code beautifully things and I love what I do.</p>
        <div className='flex justify-center w-[75%] xl:mt-[170px] md:mt-[85px] mt-[120px]'>
            <div className="text-white text-[50px] flex items-center justify-center">
               <img src='https://i.postimg.cc/qBLmRzL3/round-text.png' alt="myprojectsphoto" className='absolute animate-spin-slow xl:w-[200px] md:w-[100px] w-[150px]'/>
        ...
        <div className="mt-[100px] flex xl:flex-row md:flex-row flex-col xl:gap-[100px] md:gap-[50px] gap-[100px]">
            <div>
                ...
                className="xl:text-[80px] md:text-[40px] text-[60px]">1+</h3>
                <p className="xl:text-[20px] md:text-[10px] w-[100px] text-[#6d8d8e] mt-[20px]">YEARS OF EXPERIENCE </p>
            </div>
            <div>
                <h3
                style={{
                ...
                className="xl:text-[80px] md:text-[40px] text-[60px]">2+</h3>
                <p className="xl:text-[20px] md:text-[10px] w-[100px] text-[#6d8d8e] mt-[20px]">PROJECTS COMPLETED</p>
            </div>
        </div>
    </div>
  }
