  ...
  return (
    <div className="xl:w-[60%] md:w-[60%] w-full xl:pt-0 md:pt-0 pt-[50px] xl:pl-0 md:pl-0 pl-[50px] mt-[200px]">
      <div className="flex text-white border-white border-[1px] w-[150px] h-[35px] rounded-full gap-[5px] items-center justify-center">
        ...
        <p>
        {language=="AZ"?"XİDMƏTLƏR":"SERVICES"}
        </p>
      </div>
      <div className="mt-[50px]">
        ...
        {language=="AZ"?"Mənim ":"My "}
          ...
          > 
          {language=="AZ"?"İxtisaslaşmalar ":"Specializations "}
        ...
        <div className="md:w-[92%] flex justify-between border-2 border-white hover:border-[#5c797a] transition-all duration-500 rounded-3xl h-[185px] px-[40px] pt-[40px]">
          <div className="text-white">
            <h4 className="xl:text-[28px] md:text-[20px]">
            {language=="AZ"?"Proqramlaşdırma ":"Development "}
            </h4>
            <p className="text-[#5c797a] md:text-[14px]">
              {language=="AZ"?"Mən veb saytlar qururam və onları JavaScript və React istifadə edərək canlıya keçirirəm.":"I build website go live with Javascript and React"}
            </p>
          </div>
